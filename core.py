...
def set_p_bag_num(sum_list, p_times, bag_num_score):
    ...
    i = 0
    while i < p_times:
        bag_num_random_int = random.randint(50, 90)
        bag_list = []
...
def get_p_father(p_father_num):
    ...
    while choice_times < p_father_num:
        ...
        for each_random_int in random_int:
            ...
            p_father_dict['p' + str(each_random_int)] = p_data['p' + str(each_random_int)]
            p_father_list.append(p_data['p' + str(each_random_int)])
...
while cycles_times < termination_times:
    ...
    final_list = p_fit_data[p_sum_value_dict_sort[9][0]]
